...
class DBHelper{
  ...
  initDB() async {
    ...
    String path = join(databasePath, "lolo1.db");
  ...
  Future<FutureOr<void>> onCreate(Database db, int version) async {
    String sql = "create table afazer (afazerText varchar(50),"
                 "dataText varchar(10), isDone bool);";
    await db.execute(sql);

    sql = "INSERT INTO afazer (afazerText, dataText, isDone)"
          "VALUES('seus afazeres aparecerao aqui', '31/10/2022', 'false');";
    await db.execute(sql);
